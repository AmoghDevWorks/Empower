...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between h-20 w-full bg-zinc-100 relative p-2 border-b-2 border-solid border-black">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center text-blue-700 text-sm font-semibold bg-zinc-50 rounded-full backdrop-blur-sm px-5 py-1 overflow-hidden border border-zinc-700">
        ...
        <div className="flex items-center justify-center gap-3">
            <Link to={'/login'} className="text-blue-700 font-medium hover:text-zinc-800 transition">Log In</Link>
            <Link to={'/signup'} className="text-blue-700 rounded-full px-5 py-1.5 bg-zinc-50 font-medium flex items-center transition border border-zinc-700 relative overflow-hidden group">
                Sign Up
